<?php
    /**
     * Controlador de productos para gestionar operaciones 
     * CRUD a través de una API.
     * 
     * Este script gestiona las solicitudes para operaciones 
     * CRUD en productos, soportando el acceso desde 
     * cualquier origen y permitiendo los métodos GET y POST.
     * 
     * Además, asegura que todas las respuestas se devuelvan 
     * en formato JSON.
     */
    ...
    // 1. Incluye el archivo de configuración de conexión 
    // a la base de datos
    require_once("../config/conexion.php");

    // 2. Define la clase Producto que extiende de Conectar
    /**
     * Clase Producto que extiende de Conectar para manejar 
     * las operaciones CRUD de productos.
     * 
     * @access public
     */
    class Producto extends Conectar {
         ...
         * 
         * Valida que los parámetros proporcionados sean 
         * correctos y realiza la inserción en la base de 
         * datos.
         * 
        ...
        public function insert_producto(
            ...
            // 6. Prepara la consulta SQL para insertar un 
            // producto
            $sql = 
            "INSERT INTO tm_producto (cat_id, prod_nom, prod_desc, prod_precio, est) 
            VALUES (?, ?, ?, ?, 1)";
            ...
            // 8. Ejecuta la consulta y retorna verdadero o 
            // falso dependiendo del éxito
            if ($sql->execute()) {
                return true;
            } 
        ...
        /**
         * Obtiene todos los productos activos de la base 
         * de datos.
         * 
         * Realiza una consulta para obtener todos los productos 
         * activos y los retorna en un array asociativo.
         * 
         * @access public
         * @return array Asociativo de todos los productos 
         * activos.
         */
        public function get_productos() {
            ...
            // 12. Prepara la consulta SQL para obtener todos 
            ...
            // 14. Retorna los resultados como un array 
            // asociativo
            return $resultado = 
            $sql->fetchAll(PDO::FETCH_ASSOC);
        }

        // 15. Define el método para obtener un producto por 
        // su ID
        /**
         * Obtiene un producto por su ID.
         * 
         * Realiza una consulta para obtener un producto 
         * específico por su ID y lo retorna en un array 
         * asociativo.
         * 
         * @access public
        ...
        public function get_producto_x_id($prod_id) {
            // 16. Establece la conexión con la base de 
            // datos
            $conectar = parent::conexion();

            // 17. Establece el conjunto de caracteres a 
            // UTF-8
            parent::set_names();

            // 18. Prepara la consulta SQL para obtener un 
            // producto por su ID
            $sql = 
            "SELECT * FROM tm_producto 
            WHERE prod_id = ? AND est = 1";

            $sql = $conectar->prepare($sql);

            // 19. Vincula el ID del producto a la consulta 
            // SQL
            ...
            // 21. Retorna el resultado como un array 
            // asociativo
            return $resultado = 
         ...
         * 
         * Recibe los datos del producto a actualizar y 
         * realiza la operación en la base de datos.
         * 
         * Retorna verdadero si la actualización fue 
         * exitosa, falso en caso contrario.
         * 
         * @access public
         * @param int $prod_id ID del producto a actualizar.
         * @param int $cat_id Nueva ID de la categoría del 
         * producto.
         * 
         * @param string $prod_nom Nuevo nombre del producto.
         * @param string $prod_desc Nueva descripción del 
         * producto.
         * 
        ...
        public function update_producto(
            ...
            // 25. Prepara la consulta SQL para actualizar un 
            // producto
            $sql = 
            "UPDATE tm_producto 
            SET cat_id = ?, prod_nom = ?, prod_desc = ?, prod_precio = ? 
            WHERE prod_id = ?";
            ...
            // 28. Ejecuta la consulta y verifica si fue 
            // exitosa.
            if ($sql->execute()) {
         ...
         * 
         * Realiza una operación para eliminar un producto 
         * específico por su ID de la base de datos.
         * 
        ...
        public function delete_producto($prod_id) {
            ...
            // 32. Prepara la consulta SQL para eliminar un 
            // producto por su ID.
            ...
            // 34. Ejecuta la consulta y verifica si fue 
            // exitosa.
            if ($sql->execute()) {
                return true; // Indica una operación exitosa.
            } 
