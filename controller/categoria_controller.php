<?php
    /**
     * Controlador para la gestión de categorías y productos mediante solicitudes CORS.
     * 
     * Permite solicitudes CORS desde cualquier origen y establece los encabezados adecuados
     * para soportar métodos GET y POST, así como la inclusión de ciertos encabezados en las solicitudes.
    ...
    /**
     * Instancia del modelo de categoría para realizar operaciones CRUD.
     * 
     * @var Categoria $categoria Instancia del modelo de categoría.
     * @access public
     */
    ...
    /**
     * Instancia del modelo de producto para realizar operaciones CRUD.
     * 
    ...
    /**
     * Cuerpo de la solicitud HTTP decodificado desde JSON a un array PHP.
     * 
    ...
    switch($_GET["op"]) {
        ...
        case "GetAll":
            /**
             * Obtiene todas las categorías y las devuelve en formato JSON.
             * 
             * @return string Lista de todas las categorías en formato JSON.
             * @access public
             */
        ...
        case "GetId":
            /**
             * Obtiene una categoría por su ID y la devuelve en formato JSON.
             * 
             * @param int $body["cat_id"] ID de la categoría.
             * @return string Datos de la categoría especificada en formato JSON.
             * @access public
             */
        ...
        case "Insert":
            /**
             * Inserta una nueva categoría y devuelve un mensaje de éxito en formato JSON.
             * 
             * @param string $body["cat_nom"] Nombre de la categoría.
             * @param string $body["cat_obs"] Observaciones de la categoría.
        ...
        case "Update":
            /**
             * Actualiza una categoría existente y devuelve un mensaje de éxito en formato JSON.
             * 
             * Verifica que el ID de la categoría exista antes de proceder con la actualización y valida los datos de entrada.
             * 
             * @param int $body["cat_id"] ID de la categoría a actualizar.
             * @param string $body["cat_nom"] Nuevo nombre de la categoría.
             * @param string $body["cat_obs"] Nuevas observaciones de la categoría.
             * @return string Mensaje de éxito en formato JSON.
             * @access public
             */
        ...
        case "Delete":
            /**
             * Elimina una categoría por su ID y devuelve un mensaje de éxito en formato JSON.
             * 
             * Asegura que la categoría a eliminar exista antes de proceder con la operación.
             * 
             * @param int $body["cat_id"] ID de la categoría a eliminar.
             * @return string Mensaje de éxito en formato JSON.
             * @access public
             */
        ...
        case "InsertProducto":
            /**
             * Inserta un nuevo producto y devuelve un mensaje indicando el resultado de la operación en formato JSON.
             * 
             * Valida si todos los datos necesarios están presentes antes de realizar la inserción.
             * 
             * @param int $body['cat_id'] ID de la categoría del producto.
             * @param string $body['prod_nom'] Nombre del producto.
             * @param string $body['prod_desc'] Descripción del producto.
             * @param float $body['prod_precio'] Precio del producto.
             * @return string Mensaje indicando el resultado de la operación en formato JSON.
             * @access public
             */
        ...
        case "UpdateProducto":
            /**
             * Actualiza un producto existente y devuelve un mensaje indicando el resultado de la operación en formato JSON.
             * 
             * Verifica que todos los datos necesarios estén completos antes de proceder con la actualización.
             * 
             * @param int $body['prod_id'] ID del producto a actualizar.
             * @param int $body['cat_id'] ID de la categoría del producto.
             * @param string $body['prod_nom'] Nuevo nombre del producto.
             * @param string $body['prod_desc'] Nueva descripción del producto.
             * @param float $body['prod_precio'] Nuevo precio del producto.
             * @return string Mensaje indicando el resultado de la operación en formato JSON.
             * @access public
             */
        ...
        case "DeleteProducto":
            /**
             * Elimina un producto especificado por su ID y devuelve un mensaje indicando el resultado de la operación en formato JSON.
             * 
             * Confirma que el ID del producto proporcionado corresponde a un producto existente antes de proceder con la eliminación.
             * 
             * @param int $body['prod_id'] ID del producto a eliminar.
             * @return string Mensaje indicando el resultado de la operación en formato JSON.
             * @access public
             */
        ...
        case "GetAllProductos":
            /**
             * Obtiene todos los productos disponibles y los devuelve en formato JSON.
             * 
             * Realiza una consulta a la base de datos para recuperar todos los productos activos y los devuelve en un formato legible.
             * 
             * @return string Lista de todos los productos en formato JSON.
             * @access public
             */
